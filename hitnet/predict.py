...
def pfm_as_bytes(filename):
  ...
  # im.save('/Users/nihalkurki/Desktop/hitnet/data_disparity.png')
  cv2.imwrite('/Users/nihalkurki/Desktop/hitnet/data_disparity.png', data)
...
def evaluate(disparity, gt, psm_threshold=192, max_disparity=1e6):
  ...
  print(np.array([psm_epe, bad01, bad05, bad1, bad2, bad3]))
